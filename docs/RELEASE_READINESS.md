...
- successful and failed import-run shared-visibility expectations, plus structured adapter site-scope rejection paths, remain covered by the current smoke matrix
